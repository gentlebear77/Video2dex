...
class SimpleDP3(BasePolicy):
    def __init__(self, 
        ...
        obs_shape_meta = shape_meta['obs']['shape']
        obs_dim = obs_shape_meta[0]
    ...
    def conditional_sample(self, 
        ...
        for t in scheduler.timesteps:
            ...
            #f local_cond is None:
            #     print("Shape of local_cond is Non")
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        # print(f"data{cond_data.shape},mask{cond_mask.shape},global{global_cond.shape}")
        # run sampling
    ...
    def compute_loss(self, batch):
        ...
        # global_cond = nobs.reshape(batch_size, -1)
