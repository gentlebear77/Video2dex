...
def main():
    ...
    def create_env():
        ...
        return env
    # env = create_env()
    # pc_visual, depth_visual = env.get_point_cloud()
    # visual = Visualizer()
    # save_path = '/home/gentlebear/Diffusion_Policy/video2dex/pics/pc.xyz'
    # visual.save_visualization_to_file(pc_visual, save_path)
    # print(type(env))
    # print(type(env.get_mujoco_sim()))
    # import time
    # time.sleep(60)
